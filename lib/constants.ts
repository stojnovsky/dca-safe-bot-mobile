...
// Live spot prices (current price for live positions). Keep using cena.ambire.
export const PRICE_API_URL = 'https://cena.ambire.com/api/v3/simple/price?ids=ethereum,bitcoin&vs_currencies=usd';
// Default base URL for the historical prices backend (medit/prices-api). Override per-device in Settings.
export const DEFAULT_PRICES_API_URL = 'http://prices.skyscraper.pro'; //'http://localhost:4000';
export const DEFAULT_RPC   = 'https://invictus.ambire.com/base';
